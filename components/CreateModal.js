...
export default function CreateModal({ modalOpened, setModalOpened }) {
    ...
    return (
        ...
        <Modal overlayOpacity={0.55} overlayBlur={3} size="50%" opened={modalOpened} onClose={() => setModalOpened(false)} centered>
            <h1 className="px-auto pb-16  justify-center flex items-center text-xl font-medium "> CREATE NEW CONTACT </h1>
            ...
            <div className="pt-10 px-auto justify-center flex items-center pb-10" >
                <button class="w-1/2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={ handleSubmit}> Add To Contacts </button>
            </div>
        </Modal>
        </MantineProvider>
    )
